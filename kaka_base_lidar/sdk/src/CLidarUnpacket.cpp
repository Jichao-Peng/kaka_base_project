...
Others:       None
***********************************************************************************/
TLidarVersionInfo CLidarUnpacket::unpacketLidarVersion(CLidarPacket &packet)
{
    TLidarVersionInfo lidar_version;

    TVersionInfo packet_verison;
    memcpy(&packet_verison, packet.getParamPtr(), packet.getParamLength());

    lidar_version.device_sn = std::string(packet_verison.device_sn, sizeof(packet_verison.device_sn));
    lidar_version.software_ver = std::string(packet_verison.software_ver, sizeof(packet_verison.software_ver));
